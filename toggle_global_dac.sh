...
echo $timestamp
mkdir -p threshold/iog_$1-global_dac_$timestamp

python3 toggle_global_dac.py --pacman_config io/pacman_io$1.json --disabled_list $2 --chip_list $3 --diagnostic_dir threshold/iog_$1-global_dac_$timestamp

echo Threshold output folder
echo threshold/iog_$1-global_dac_$timestamp
