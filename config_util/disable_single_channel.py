...
def main(asic_config, channel, **kwargs):
    ...
    file = asic_config + f'/config_{iog}-{ioch}-{chip}.json'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--asic_config', type=str, default=None,
                        help='''path to the asic config folder to change''')
    parser.add_argument('--channel', type=str, default=None,
                        help='''channel to disable in the format io_group-io_channel-chip_id-channel_id''')
