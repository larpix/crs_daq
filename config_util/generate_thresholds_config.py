######################################################################################
# these settings configure the v3a larpix chips for a threshold run. Additional configs
...
def main(input_files, verbose, \
        ...
        for file in input_files:
            ...
            config['cds_mode'] = 0
            config['channel_mask'] = [1] + [0]*63
            config['csa_enable'] = [0] + [1]*63
            ...
            if 'meta' in config.keys():
                ...
                config['meta']['description']  = 'threshold'
